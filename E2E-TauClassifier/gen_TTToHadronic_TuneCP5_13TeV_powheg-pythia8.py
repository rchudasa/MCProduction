...
# with command line options: Configuration/GenProduction/python/TOP-RunIISummer20UL18wmLHEGEN-00003-fragment.py --python_filename gen_TTToHadronic_TuneCP5_13TeV_powheg-pythia8.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:TTToHadronic_TuneCP5_13TeV_powheg-pythia8_GEN.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TOP-RunIISummer20UL18wmLHEGEN-00003-fragment.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TTToHadronic_TuneCP5_13TeV_powheg-pythia8_GEN.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TTToHadronic_TuneCP5_13TeV_powheg-pythia8_GEN_inLHE.root'),
