...
# with command line options: --python_filename step3_AODSIM_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:HIG-Run3Summer23DRPremix-00923.root --conditions 130X_mcRun3_2023_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:HIG-Run3Summer23DRPremix-00923_0.root --era Run3_2023 --no_exec --mc -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_diffraction/rchudasa/MCGeneration/HToAATo4Tau_hadronic_tauDecay_M3p7_Run3_2023/3p7_DIGI-Premix_hadronicNew/241119_061119/0000/HIG-Run3Summer23DRPremix-00923_0_1.root'),
