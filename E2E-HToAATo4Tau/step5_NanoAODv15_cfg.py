...
# with command line options: --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 150X_mcRun3_2023_realistic_postBPix_v1 --step NANO --era Run3_2023,run3_nanoAOD_pre142X --python_filename step5_NanoAODv15_cfg.py --fileout file:NanoAODv15.root --no_exec --mc
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:MINIAODSIM_RAWAOD_RecHits_ATauTau_1.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:NanoAODv15.root'),
