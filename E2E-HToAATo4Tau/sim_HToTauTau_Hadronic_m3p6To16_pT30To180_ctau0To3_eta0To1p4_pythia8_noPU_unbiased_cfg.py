...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:GEN_HToAAToTauTau_M3p7_100Ev.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = process.AODSIMEventContent.outputCommands+cms.untracked.vstring('keep *_simSiPixelDigis_*_*','keep *_simSiStripDigis_*_*','keep *_siPixelClusters_*_*','keep *_siStripClusters_*_*','keep *_g4SimHits_*_*','keep *_generalTracks_*_*','keep *_siStripMatchedRecHits_*_*','keep *_siPixelRecHits_*_*','keep *_hbhereco_*_*','keep *_hbheprereco_*_*','keep *_hfprereco_*_*','keep *_hfreco_*_*','keep *_horeco_*_*'),
    fileName = cms.untracked.string('file:SIM_HToAATo4Tau_m3p7_noPU.root')
)
