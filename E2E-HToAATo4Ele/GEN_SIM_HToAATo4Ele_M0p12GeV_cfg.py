...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HToAATo4Ele_0p12GeV.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
	    ...
	    'HiggsBSM:gg2H2 = on',   # Switch on gg->H^0(H_2^0) scattering via loop contributions primarily from top. Code 1022.
            '9000036:all = A Abar   0   0   0   0.12   1e-8   0   2e02   0.0',#name antiName spinType chargeType colType m0 mWidth mMin mMax tau0
            '9000036:oneChannel = 1 1 101 11 -11',
            '9000036:mayDecay = on',
            '9000036:isResonance = off',
            '35:addChannel = 1 1e-8 101 9000036 9000036',
            '35:m0 = 125.0',
            '35:onMode = off',
            '35:onIfMatch = 9000036 9000036',
            '9000036:onMode = off',
