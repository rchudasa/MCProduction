...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HToAATo4Ele_1GeV.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
	    ...
	    'HiggsBSM:gg2H2 = on',   # Switch on gg->H^0(H_2^0) scattering via loop contributions primarily from top. Code 1022.
            '9000036:all = A Abar   0   0   0  1.0   1e-8   0   2e02   0.0',#name antiName spinType chargeType colType m0 mWidth mMin mMax tau0
