...
# with command line options: Configuration/GenProduction/python/DYMuMu_private-fragment.py --python_filename check_DYToMuMu_M-50_13TeV-powheg_pythia8_GEN-SIM_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:DYToMuMu_M-50_13TeV-powheg_pythia8_GEN-SIM.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/DYMuMu_private-fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DYToMuMu_M-50_13TeV-powheg_pythia8_GEN-SIM.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DYToMuMu_M-50_13TeV-powheg_pythia8_GEN-SIM_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    #args = cms.vstring('/eos/cms/store/group/phys_heavyions/rchudasa/e2e/Z_slc7_amd64_gcc700_CMSSW_10_6_28_my_ZMuMu.tgz'),
